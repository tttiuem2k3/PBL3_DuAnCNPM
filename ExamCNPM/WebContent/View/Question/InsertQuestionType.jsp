		...
		<div id="sidebar" class="sidebar responsive ace-save-state">
			...
			<ul class="nav nav-list">
				...
				<li class="open"><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class="active"><a href="InsertQuestionType"> <i
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active"><a href="">Insert Question Types</a></li>
					</ul>
					<!-- /.breadcrumb -->
									...
									<form method="POST" action="InsertQuestionType?pageid=1">
										...
										<div class="form-group">
											<div class="control-group" id="fields">
												<label class="control-label" for="option">Question
													type</label>
												...
												<br> <input type="text" name="questiontypename"
													id="questiontypename" style="height: 80px, semi-colon=80%"
