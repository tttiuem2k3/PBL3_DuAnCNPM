									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label" for="time">Question
													Type</label> <select id="questiontype" name="questiontype"
													class="form-control">
													<option value="Toiec">Toiec</option>
													<option value="Math">Math</option>
													<option value="Software Engenering">Software
														Engenering</option>
												</select>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label" for="name">Question</label> <input
													id="questioncontent" name="questioncontent" type="text"
										...
										<div class="col-md-12">
											<div class="form-group">
															...
															<table class="table table-bordered" id="dynamic_field">
																<tr>
																	<td><textarea style="height: 80px, width=80%"
																			name="name[]" placeholder="Enter Option Content"
																			class="form-control name_list"></textarea></td>
																	<td>
																		<button type="button" name="add" id="add"
																			class="btn btn-success">
																			<strong>+</strong>
																		</button> <input type="checkbox" id="option1" />
																	</td>
												...
												<input value="ADD" id="singlebutton" name="singlebutton"
													class="btn btn-info" />
											</div>
