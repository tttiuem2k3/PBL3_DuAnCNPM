			...
			<ul class="nav nav-list">
				...
				<li class="open"><a href="#QuestionManager"
					...
					<ul class="submenu">
						...
						<li class="active"><a href="UpdateDeleteQuestion?pageid=1">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active"><a href="">Update & Delete Questions</a></li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Update & Delete Questions <small> <i
					...
					<div class="" id="UpdateDeleteQuestion ">
							...
							<tr>
								...
								<th>
									<button type="button" id="AddNewQuestion"
										class="btn btn-xs btn-info" onclick="return AddNewQuestion()">AddQuestion</button>
								</th>
							</tr>
							<tbody id="myTable">
									...
									<tr class="text-center">
										...
										<td class="text-center" style="text-align: center !important;">
											<div class="btn-group">
												...
												<a href="myBtn${list.questionid}" name="edit"
													data-toggle="tooltip" title=""
													class="btn btn-xs btn-success" data-original-title="Edit">
													<i class="fa fa-pencil"> </i>
												</a> <a href="DeleteQuestion?index=${list.questionid}&pageid=1"
													data-toggle="tooltip" title=""
													class="btn btn-xs btn-danger" data-original-title="Delete"
						...
						<ul class="pagination">
							...
							<c:if test="${numberpage==1}">
								...
								<li><a href="UpdateDeleteQuestion?pageid=${numberpage+1}">&raquo;</a>
								</li>
							</c:if>
							...
							<c:if test="${numberpage>1 && numberpage<maxpageid}">
								<li><a href="UpdateDeleteQuestion?pageid=${numberpage-1}">&laquo;</a>
								</li>
								<li><a href="UpdateDeleteQuestion?pageid=1">1</a></li>
								<li><a href="UpdateDeleteQuestion?pageid=2">2</a></li>
								<li><a href="UpdateDeleteQuestion?pageid=${numberpage+1}">&raquo;</a>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form action="SaveEditQuestion?pageid=1" method="POST"
						name="frmInsertAcc">
						<div class="form-group">
							<label for="questionid">Question ID</label> <input type="text"
								class="form-control" name="questionid" id="questionid"
								placeholder="Question ID" value="${list.questiontypename}"
								disabled />
						</div>
						<div class="form-group">
...
// 											("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");									
						...
						<div class="form-group">
							<label for="questiontype">Questiontype</label> <input type="text"
								class="form-control" name="questiontype" id="questiontype"
								placeholder="Questiontype"> <br>
							<%
														    try{
														//Class.forName("com.mysql.jdbc.Driver").newInstance();
														Class.forName("com.mysql.jdbc.Driver");
...
// 													         ("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");													
						...
						<div class="form-group">
							<label for="contentquestion">Content</label> <input type="text"
								class="form-control" name="contentquestion" id="contentquestion"
								placeholder="Content" value="${list.contentquestion}">
						</div>
						<div class="form-group">
							<label class="control-label" for="appointmentfor">Number
								of Options</label> <input type="text" id="number" name="number"
								value="1" placeholder="Content" class="form-control input-md">
						</div>
						<div class="form-group">
...
// 													         ("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");													
										...
										<table class="table table-bordered" id="dynamic_field">
											...
											<tr>
												<td><textarea style="height: 80px, width=80%"
														...
														value="<%= resultset.getString(1)%>"><%= resultset.getString(2)%></textarea>
												</td>
												<td style="max-width: 51px;">
													<button type="button" name="add" id="add"
														class="btn btn-success">
														<strong>+</strong>
													</button> <input type="checkbox" id="optioncb[]" name="optionCheck"
													+i value="<%= resultset.getString(3)%>"
						...
						<div class="form-group">
							<label for="media">Mediaid</label> <input type="file"
								class="form-control" name="media" id="media" placeholder="File">
						</div>
