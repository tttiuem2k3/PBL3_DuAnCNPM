			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="form-group" style="margin: 30px">
						...
						<form action="InsertAccount?pageid=1" method="post"
							name="frmInsertAcc" class="form-horizontal">

							<br> Username: <br> <input type="text" name="username"
								id="username" style="border: 1px solid #00ffc1"><br>
							<br> PassWord: <br> <input type="text" name="pass"
								id="pass" style="border: 1px solid #00ffc1"><br> <br>
							Fullname: <br> <input type="text" name="fullname"
								id="fullname" style="border: 1px solid #00ffc1"><br>
							<br> Birthday: <br> <input type="date" name="birthday"
								id="birthday" style="border: 1px solid #00ffc1"><br>
							<br> Country: <br> <input type="text" name="country"
								id="country" style="border: 1px solid #00ffc1"><br>
							<br> Phone: <br> <input type="text" name="phone"
								id="phone" style="border: 1px solid #00ffc1"><br> <br>
							Image: <br> <input type="text" name="image" id="image"
...
// 										 ("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");								
							...
							<br> <br> <input type="submit" value="Save"
								style="background: skyblue;" onclick="return KiemTraHopLe()"><br>
						</form>
					</div>
