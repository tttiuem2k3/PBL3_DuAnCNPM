		...
		<div class="main-content">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="">
						<h2>List User</h2>
						Date : <input type="date" id="date" name="date"> <span
							style="margin-left: 50px;">Class : </span>
						<%
							    try{
									...
									<tr>
										...
										<td class="center">
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="skyblue" href="#" id="myBtn${list.resultid }">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form action="UpdateResult?pageid=1" method="POST"
						name="frmInsertAcc">
						<div class="form-group">
							<label for="usrname">Result ID</label> <input type="text"
								class="form-control" name="resultid" id="resultid"
								placeholder="Result Test ID">
						</div>
						<div class="form-group">
							<label for="psw">User ID</label> <input type="text"
						...
						<div class="form-group">
							<label for="psw">Fullname</label> <input type="text"
								class="form-control" name="fullname" id="fullname"
								placeholder="Fullname" disabled>
						</div>
						<div class="form-group">
							<label for="usrname">Point</label> <input type="text"
								class="form-control" name="point" id="point" placeholder="Point">
						</div>
						<div class="form-group">
