							...
							<tr style="background: skyblue">
								...
								<th>
									<button type="button" id="AddNewUser"
										style="background: #40ff00" onclick="return AddNewUser()">Add
										User</button>
								</th>
							</tr>
							<tbody id="myTable">
									...
									<tr>
										...
										<td class="center">
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="skyblue" href="#" id="myBtn${list.userid }"> <i
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form action="SaveEditAccount?pageid=1" method="POST"
						...
						<div class="form-group">
							<label for="usrname">User ID</label> <input type="text"
						...
						<div class="form-group">
							<label for="psw">Password</label> <input type="text"
								class="form-control" name="pass" id="pass"
								placeholder="Password">
						</div>

						<div class="form-group">
							<label for="usrname">Fullname</label> <input type="text"
								class="form-control" name="fullname" id="fullname"
								placeholder="Fullname">
						</div>
						<div class="form-group">
							<label for="psw">Birthday</label> <input type="date"
						...
						<div class="form-group">
							<label for="psw">Phone</label> <input type="text"
								class="form-control" name="phone" id="phone" placeholder="Phone">
						</div>
						<div class="form-group">
							<label for="psw">Image</label> <input type="text"
								class="form-control" name="image" id="image" placeholder="Image">
						</div>
						<div class="form-group">
							<label for="psw">Roleid</label><br> <select name="roleid"
								id="roleid">
						...
						<div class="form-group">
							<label for="psw">Classid</label> <input type="text"
