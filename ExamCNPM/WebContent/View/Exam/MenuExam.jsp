	...
	<div id="sidebar" class="sidebar responsive ace-save-state">
		...
		<ul class="nav nav-list">
			...
			<li class=""><a href="#" class="dropdown-toggle"> <i
				...
				<ul class="submenu">
					<li class=""><a href="CreateTestSheet?pageid=1"> <i
							class="menu-icon fa fa-caret-right"></i> Create Test Sheet <b
							class="arrow"></b>
					</a> <b class="arrow"></b>
					<li class=""><a href="EditExam?pageid=1"> <i
		...
		<li class=""><a href="#" class="dropdown-toggle"> <i
				class="menu-icon fa fa-pencil-square-o"></i> <span class="menu-text">
					Manage Class Exam </span> <b class="arrow fa fa-angle-down"></b>
		</a> <b class="arrow"></b>

			<ul class="submenu">
				<li class=""><a href="ViewListClassExam?pageid=1"> <i
						class="menu-icon fa fa-caret-right"></i> View List Class Exam
				</a> <b class="arrow"></b></li>

				<li class=""><a href="EditListClassExam?pageid=1"> <i
