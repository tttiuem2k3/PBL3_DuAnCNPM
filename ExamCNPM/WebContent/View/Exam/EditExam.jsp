			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Edit Exam <small> <i
								class="ace-icon fa fa-angle-double-right"></i> Manage Exam can
								edit test sheet
							</small>
						</h1>
					</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form action="UpdateTimeExam?pageid=1" method="POST"
						name="frmInsertAcc">
						<div class="form-group">
							<label for="usrname">Test ID</label> <input type="text"
								class="form-control" name="testid" id="testid"
								placeholder="TestID">
						</div>
						<div class="form-group">
							<label for="usrname">Date time start</label> <input
								type="datetime" class="form-control" name="datetimestart"
								id="datetimestart" placeholder="Date time start">
						</div>
						<div class="form-group">
							<label for="usrname">Date time end</label> <input type="datetime"
								class="form-control" name="datetimeend" id="datetimeend"
								placeholder="Date time start">
						</div>
						<div class="form-group">
							<label for="psw">Time</label> <input type="time"
