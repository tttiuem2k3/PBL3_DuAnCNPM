		...
		<div class="main-content">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="col-md-5 top-header-agile-left table-responsive"
						style="margin: 30px">
						<h2>Create Exam</h2>
						<div id="thongbao">
							<p id="pthongbao"></p>
						...
						<form action="CreateTestSheet?pageid=1" method="post"
							name="frmCreateTest">
...
// ("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");						
							...
							%>
							<br> <br> Date time start: <br> <input
								type="datetime-local" name="timestart" id="timestart"
								style="border: 1px solid #00ffc1" /><br> <br> Date
							time end: <br> <input type="datetime-local" name="timeend"
								id="timeend" style="border: 1px solid #00ffc1" /><br> <br>
							Test type id: <br>
							<%
							    try{
							//Class.forName("com.mysql.jdbc.Driver").newInstance();
...
// ("jdbc:mysql://node10595-examonline.fr-1.paas.massivegrid.net/examonline?useUnicode=true&characterEncoding=UTF-8","root","BSOxar77141");						
							...
							%>
							<br> <br> Number of question :<br> <input
								type="number" name="number" id="number" min="1"
								placeholder="Enter number of question"
								style="border: 1px solid #00ffc1"><br> <br>
							Time : <br> <input type="time" name="time" id="time" min="1"
								style="border: 1px solid #00ffc1"><br> <br> <input
								type="submit" value="Create Test Sheet"
